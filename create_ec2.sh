...
main() {
    ...
    KEY_NAME="Bash-key"
    SUBNET_ID="subnet-0be1fc2a913035242"
    SECURITY_GROUP_IDS="sg-0dfff8a481813f7a1"  # Add your security group IDs separated by space
    INSTANCE_NAME="Deploying-by-bash"
